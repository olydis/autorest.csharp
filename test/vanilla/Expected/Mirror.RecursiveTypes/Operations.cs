...
namespace Fixtures.MirrorRecursiveTypes.Models {     using Microsoft.Rest;
...
namespace Fixtures.MirrorRecursiveTypes
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<RecursiveTypesAPI>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(RecursiveTypesAPI client)
        {
            if (client == null)
            {
