...
namespace Fixtures.ExtensibleEnums.Models {     using Microsoft.Rest;
...
namespace Fixtures.ExtensibleEnums
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<PetStoreInc>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(PetStoreInc client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<Pet>> Pet_GetByPetId(string petId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (petId == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<Pet>> Pet_AddPet(Pet petParam = default(Pet), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (petParam != null)
            {
                petParam.Validate();
