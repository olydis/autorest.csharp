...
namespace Fixtures.CustomBaseUriMoreOptions.Models {     using Microsoft.Rest;
...
namespace Fixtures.CustomBaseUriMoreOptions
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<AutoRestParameterizedCustomHostTestClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutoRestParameterizedCustomHostTestClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse> paths_getEmpty(string vault, string secret, string keyName, string keyVersion = "v1", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vault == null)
            {
