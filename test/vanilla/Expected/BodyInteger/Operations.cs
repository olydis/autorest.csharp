...
namespace Fixtures.BodyInteger.Models {     using Microsoft.Rest;
...
namespace Fixtures.BodyInteger
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<AutoRestIntegerTestService>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutoRestIntegerTestService client)
        {
            if (client == null)
            {
