...
namespace Fixtures.UrlMultiCollectionFormat.Models {     using Microsoft.Rest;
...
namespace Fixtures.UrlMultiCollectionFormat
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<AutoRestUrlMutliCollectionFormatTestService>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutoRestUrlMutliCollectionFormatTestService client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse> queries_ArrayStringMultiNull(IList<string> arrayQuery = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> queries_ArrayStringMultiEmpty(IList<string> arrayQuery = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> queries_ArrayStringMultiValid(IList<string> arrayQuery = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
