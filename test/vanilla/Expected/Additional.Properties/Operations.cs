...
namespace Fixtures.AdditionalProperties.Models {     using Microsoft.Rest;
...
namespace Fixtures.AdditionalProperties
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<PetStoreonHeroku>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(PetStoreonHeroku client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<IList<Pet>>> get_pets(int? limit = 11, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (limit > 10000)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> post_pets(Pet pet, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (pet == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> put_pets(Pet pet, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (pet == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "pet");
