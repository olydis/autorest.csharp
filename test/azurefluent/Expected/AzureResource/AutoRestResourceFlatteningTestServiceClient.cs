...
namespace Fixtures.Azure.Fluent.AzureResource
{
    ...
    public partial class AutoRestResourceFlatteningTestServiceClient : ServiceClient<AutoRestResourceFlatteningTestServiceClient>, IAutoRestResourceFlatteningTestServiceClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse> PutArrayAsync(IList<Resource> resourceArray = default(IList<Resource>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
