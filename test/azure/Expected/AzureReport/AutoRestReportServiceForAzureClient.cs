...
namespace Fixtures.Azure.AzureReport
{
    ...
    /// </summary>
    public partial class AutoRestReportServiceForAzureClient : ServiceClient<AutoRestReportServiceForAzureClient>, IAutoRestReportServiceForAzureClient
    {
        /// <summary>
        ...
        /// </param>
        public AutoRestReportServiceForAzureClient(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public AutoRestReportServiceForAzureClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public AutoRestReportServiceForAzureClient(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestReportServiceForAzureClient(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// </return>
        public async Task<AzureOperationResponse<IDictionary<string, int?>>> getReport(string qualifier = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
