...
namespace Fixtures.Azure.AzureReport
{
    ...
    public partial interface IOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IDictionary<string, int?>>> getReport(string qualifier = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
