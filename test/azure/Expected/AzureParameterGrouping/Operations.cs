...
namespace Fixtures.Azure.AzureParameterGrouping
{
    ...
    internal partial class Operations : IServiceOperations<AutoRestParameterGroupingTestServiceClient>, IOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse> parameterGrouping_postRequired(int body, string path, string customHeader = default(string), int? query = 30, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (path == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> parameterGrouping_postOptional(string customHeader = default(string), int? query = 30, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> parameterGrouping_postMultiParamGroups(string headerOne = default(string), int? queryOne = 30, string headerTwo = default(string), int? queryTwo = 30, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> parameterGrouping_postSharedParameterGroupObject(string headerOne = default(string), int? queryOne = 30, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
