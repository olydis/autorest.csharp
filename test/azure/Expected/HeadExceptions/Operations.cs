...
namespace Fixtures.Azure.HeadExceptions.Models {     using Microsoft.Rest;
...
namespace Fixtures.Azure.HeadExceptions
{
    ...
    /// Operations.
    /// </summary>
    internal partial class Operations : IServiceOperations<AutoRestHeadExceptionTestService>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutoRestHeadExceptionTestService client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> headException_head200(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> headException_head204(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> headException_head404(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
