...
namespace Fixtures.Azure.CustomBaseUri.Models {     using Microsoft.Rest;
...
namespace Fixtures.Azure.CustomBaseUri
{
    ...
    internal partial class Operations : IServiceOperations<AutoRestParameterizedHostTestClient>, IOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse> paths_getEmpty(string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (accountName == null)
            {
